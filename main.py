...
with col2:
    drivenkms = st.text_input('How much car has been driven in KMs?', placeholder='Enter the  KMs driven...',
                              max_chars=6)
...
data = np.array([Present_Price, Kms_Driven, Owner, How_Old, Fuel_Type_Diesel, Fuel_Type_Petrol, Seller_Type_Individual,
